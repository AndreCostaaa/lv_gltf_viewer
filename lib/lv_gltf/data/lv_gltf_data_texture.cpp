...
void lv_gltf_data_destroy_textures(lv_gltf_data_t * data)
{
    ...
    glDeleteTextures(data->skin_tex.size(),
                     data->skin_tex.data());
    data->skin_tex.clear();
}
...
bool lv_gltf_data_get_texture_pixels(uint8_t * pixels,
                                       ...
                                       uint32_t model_texture_index)
{
    ...
    if(lv_gltf_data_get_texture_info(
        ...
        if(lv_gltf_data_get_texture_pixels(
