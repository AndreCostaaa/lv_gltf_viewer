...
lv_gltf_bind_t *add_by_node(lv_gltf_data_t *gltf_data, fastgltf::Node *node, lv_gltf_bind_prop_t which_prop, uint32_t data_mask,
...
lv_gltf_bind_t *lv_gltf_bind_add_by_index(lv_gltf_data_t *data, size_t index, lv_gltf_bind_prop_t which_prop, uint32_t data_mask,
					  lv_gltf_bind_dir_t dir)
{
...
lv_gltf_bind_t *lv_gltf_bind_add_by_ip(lv_gltf_data_t *data, const char *ip, lv_gltf_bind_prop_t which_prop, uint32_t data_mask,
				       lv_gltf_bind_dir_t dir)
{
