...
lv_gltf_uniform_locs * get_uniform_ids(lv_gltf_data_t * data, size_t I)
{
    return &data->shader_uniforms[I];
}

void lv_gltf_data_set_shader(lv_gltf_data_t * data, size_t index, lv_gltf_uniform_locs uniforms,
