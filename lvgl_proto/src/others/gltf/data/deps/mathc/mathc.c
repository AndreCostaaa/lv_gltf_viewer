...
// MK - I can't figure out why this is trying to access element 8 of a supplied quaternion.  THey only have 4 elements.  Corrected below
...
mfloat_t *quat_divide(mfloat_t *result, mfloat_t *q0, mfloat_t *q1)
{
    ...
    // Corrected the access to q1
    mfloat_t ls = q1[0] * q1[0] + q1[1] * q1[1] + q1[2] * q1[2] + q1[3] * q1[3];
    
    mfloat_t normalized_x = -q1[0] / ls;
    mfloat_t normalized_y = -q1[1] / ls;
    mfloat_t normalized_z = -q1[2] / ls; // Corrected from q1[8]
    mfloat_t normalized_w = q1[3] / ls;
...
mfloat_t *mat3_rotation_quat(mfloat_t *result, mfloat_t *q0)
{
	...
	//mfloat_t xz = q0[8] * q0[0];  // MK - Again, not sure why element 8 would be accessed here.
...
{
	return (struct vec2_st *)vec2_bezier4((mfloat_t *)result, (mfloat_t *)v0, (mfloat_t *)v1, (mfloat_t *)v2, (mfloat_t *)v3, f);
}
...
{
	return (struct vec3_st *)vec3_bezier4((mfloat_t *)result, (mfloat_t *)v0, (mfloat_t *)v1, (mfloat_t *)v2, (mfloat_t *)v3, f);
}
...
{
	return (struct mat2_st *)mat2((mfloat_t *)result, m11, m12, m21, m22);
}

struct mat2_st *psmat2_zero(struct mat2_st *result)
{
	return (struct mat2_st *)mat2_zero((mfloat_t *)result);
}

struct mat2_st *psmat2_identity(struct mat2_st *result)
{
	return (struct mat2_st *)mat2_identity((mfloat_t *)result);
}
...
{
	return (struct mat3_st *)mat3((mfloat_t *)result, m11, m12, m13, m21, m22, m23, m31, m32, m33);
}

struct mat3_st *psmat3_zero(struct mat3_st *result)
{
	return (struct mat3_st *)mat3_zero((mfloat_t *)result);
}

struct mat3_st *psmat3_identity(struct mat3_st *result)
{
	return (struct mat3_st *)mat3_identity((mfloat_t *)result);
}
...
{
	return (struct mat4_st *)mat4((mfloat_t *)result, m11, m12, m13, m14, m21, m22, m23, m24, m31, m32, m33, m34, m41, m42, m43, m44);
}

struct mat4_st *psmat4_zero(struct mat4_st *result)
{
	return (struct mat4_st *)mat4_zero((mfloat_t *)result);
}

struct mat4_st *psmat4_identity(struct mat4_st *result)
{
	return (struct mat4_st *)mat4_identity((mfloat_t *)result);
}
