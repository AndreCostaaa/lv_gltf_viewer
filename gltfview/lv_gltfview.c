...
#include "gltfview/lv_gltfview_internal.h"

gl_viewer_desc_t* lv_gltfview_get_desc(lv_gltfview_t * view);
...
float lv_gltfview_get_focal_x (lv_gltfview_t * view) { return lv_gltfview_get_desc(view)->focal_x; }
float lv_gltfview_get_focal_y (lv_gltfview_t * view) { return lv_gltfview_get_desc(view)->focal_y; }
float lv_gltfview_get_focal_z (lv_gltfview_t * view) { return lv_gltfview_get_desc(view)->focal_z; }
...
bool lv_gltfview_check_frame_was_cached(lv_gltfview_t * view) {
    return lv_gltfview_get_desc(view)->frame_was_cached;
}
bool lv_gltfview_check_frame_was_antialiased(lv_gltfview_t * view) {
    return lv_gltfview_get_desc(view)->frame_was_antialiased;
}
